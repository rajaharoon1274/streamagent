    ...
    <>
      {chapters.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '12px 0' }}>
          ...
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--t1)', marginBottom: 4 }}>No Chapters Yet</div>
          <div style={{ fontSize: 10, color: 'var(--t3)', marginBottom: 14, lineHeight: 1.5 }}>
            AI will analyze your video and create chapter markers with timestamps.
          </div>
          <button
        ...
        <>
          ...
          {chapters.map((ch, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '6px 8px', borderRadius: 8, background: 'var(--s3)', border: '1px solid var(--b2)', marginBottom: 5 }}>
              <input
                value={ch.emoji}
              ...
              <input
                ...
                style={{ width: 42, fontSize: 9, fontFamily: 'var(--mono)', padding: '3px 4px', background: 'var(--s2)', border: '1px solid var(--b2)', borderRadius: 5, textAlign: 'center', color: 'var(--acc)', fontWeight: 700, outline: 'none' }}
              />
              <input
                value={ch.title}
