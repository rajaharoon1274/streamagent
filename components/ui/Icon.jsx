// SVG icon system matching the original HTML ico() function
export function Icon({ name, size = 14, color = 'currentColor', className = '' }) {
  const icons = {
    ...
    branch: <><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M13 6h3a2 2 0 0 1 2 2v7"/><line x1="6" y1="9" x2="6" y2="21"/></>,
    ...
    qr: <><rect x="3" y="3" width="5" height="5"/><rect x="16" y="3" width="5" height="5"/><rect x="3" y="16" width="5" height="5"/><rect x="4" y="4" width="3" height="3"/><rect x="17" y="4" width="3" height="3"/><rect x="4" y="17" width="3" height="3"/><path d="M21 16h-3a2 2 0 0 0-2 2v3"/><line x1="16" y1="21" x2="21" y2="21"/><path d="M15 16h.01"/><path d="M21 11V8h-3"/><line x1="15" y1="11" x2="21" y2="11"/></>,
